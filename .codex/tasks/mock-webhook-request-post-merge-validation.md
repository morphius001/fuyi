# mock-webhook-request-post-merge-validation

## 目标

记录 PR #120 合并后的支付通知 mock webhook request contract 验证结果。

## 允许修改

- `docs/mock-webhook-request-post-merge-validation.md`
- `.codex/tasks/mock-webhook-request-post-merge-validation.md`
- `.codex/queue.md`
- `project-ledger/**`
