# payment-db-adapter-post-merge-validation

## 目标

记录 DB adapter skeleton 合并后的验证结果。

## 允许修改

- `docs/payment-db-adapter-post-merge-validation.md`
- `.codex/tasks/payment-db-adapter-post-merge-validation.md`
- `.codex/queue.md`
- `project-ledger/**`
