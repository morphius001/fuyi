...
规划 local PG client / refund inbox DB adapter 在新 migration constraints 下移除 DB-safe state / actor mapping 的范围、验证和回滚。

## 允许范围

- 新增 `docs/refund-inbox-schema-adapter-unmapped-state-plan.md`
- 更新 `.codex/queue.md`
