...
记录 PR #366 合并后验证，确认 local PG refund inbox adapter 原样写入/读回 refund state / actor，但仍未启用真实退款 runtime。

## 允许范围

- 新增 `docs/refund-inbox-schema-adapter-unmapped-state-validation.md`
- 更新 `.codex/queue.md`
...
- focused local client / refund repository / payment repository / refund route tests
- API typecheck
- payment harness
