...
新增本地 disposable PostgreSQL rehearsal 脚本，验证未来 refund schema / constraint migration 草案的 SQL 语义。

## 允许范围

- 新增 `.codex/scripts/refund-schema-constraint-migration-rehearsal.sh`
- 新增 `docs/refund-schema-constraint-migration-rehearsal.md`
- 更新 `.codex/queue.md`
