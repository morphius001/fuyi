...
记录 PR #363 合并后验证，确认真实 migration skeleton 约束扩展已通过本地 disposable DB rehearsal，但仍未注册 module 或启用退款 runtime。

## 允许范围

- 新增 `docs/refund-schema-constraint-migration-validation-v2.md`
- 更新 `.codex/queue.md`
