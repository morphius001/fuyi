...
规划 approval persistence repository adapter 在 isolated preprod 中的读写边界、fail-closed 规则和回滚门槛。

## 范围

- 新增 `docs/refund-state-mutation-approval-persistence-adapter-plan.md`。
