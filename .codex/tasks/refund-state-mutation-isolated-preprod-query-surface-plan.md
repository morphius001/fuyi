...
规划 isolated preprod operator review 查询面如何安全读取 approval / audit / runtime attempt / terminal conflict 四段 persistence evidence，并保持 redacted / fail-closed。

## 范围

- 新增 `docs/refund-state-mutation-isolated-preprod-query-surface-plan.md`。
