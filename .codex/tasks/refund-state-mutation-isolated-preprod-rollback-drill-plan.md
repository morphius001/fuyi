...
规划 isolated preprod refund state mutation rehearsal 的 rollback drill、operator checklist、evidence capture 和 kill-switch 回退步骤。

## 范围

- 新增 `docs/refund-state-mutation-isolated-preprod-rollback-drill-plan.md`。
