...
规划 runtime attempt persistence repository adapter 在 isolated preprod 中的写入边界、查询边界、fail-closed 规则和回滚门槛。

## 范围

- 新增 `docs/refund-state-mutation-runtime-attempt-persistence-adapter-plan.md`。
