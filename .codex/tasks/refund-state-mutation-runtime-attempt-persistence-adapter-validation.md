...
验证 `refund-state-mutation-runtime-attempt-persistence-adapter-plan` 合并后的文件范围、No-Go 边界和下一步任务注册状态。

## 范围

- 新增 `docs/refund-state-mutation-runtime-attempt-persistence-adapter-validation.md`。
- 补齐后续队列任务所需的 task file 注册。
