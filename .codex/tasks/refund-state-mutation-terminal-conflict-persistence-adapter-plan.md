...
规划 terminal conflict persistence repository adapter 在 isolated preprod 中的写入边界、查询边界、fail-closed 规则和回滚门槛。

## 范围

- 新增 `docs/refund-state-mutation-terminal-conflict-persistence-adapter-plan.md`。
