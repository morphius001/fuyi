...
- 当前活跃分支：`china/pr-th-refund-state-mutation-isolated-preprod-query-surface-fixture-registry-decision-guard-contract-validation`
- 当前 `origin/main` 最新合并提交：`c3b5eaf` `[china] Refund state mutation isolated preprod query surface fixture registry decision guard contract plan (#522)`
- 最近已合并 PR：`#455`、`#456`、`#457`、`#458`、`#459`、`#460`、`#461`、`#462`、`#463`、`#464`、`#465`、`#466`、`#467`、`#468`、`#469`、`#470`、`#471`、`#472`、`#473`、`#474`、`#475`、`#476`、`#477`、`#478`、`#479`、`#480`、`#481`、`#482`、`#483`、`#484`、`#485`、`#486`、`#487`、`#488`、`#489`、`#490`、`#491`、`#492`、`#493`、`#494`、`#495`、`#496`、`#497`、`#498`、`#499`、`#500`、`#501`、`#502`、`#503`、`#504`、`#505`、`#506`、`#507`、`#508`、`#509`、`#510`、`#511`、`#512`、`#513`、`#514`、`#515`、`#516`、`#517`、`#518`、`#519`、`#520`、`#521`、`#522`
- 当前自动队列任务：`refund-state-mutation-isolated-preprod-query-surface-fixture-registry-decision-guard-contract-validation`
...
- `refund-state-mutation-isolated-preprod-query-surface-fixture-registry-decision-guard-contract-plan`: done，PR #522 已合并，当前主线已固定 `decisionGuards` 的 allow/deny 字段、block code 聚合、missing evidence flags 和 fail-closed 默认值。
- `refund-state-mutation-isolated-preprod-query-surface-fixture-registry-decision-guard-contract-validation`: in-progress，当前正在做 docs-only validation 与 ledger 收口。
- 下一步建议：完成本轮收口后，进入 `refund-state-mutation-isolated-preprod-query-surface-fixture-registry-operator-hint-contract-plan`。
