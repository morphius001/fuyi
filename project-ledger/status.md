...
- 当前活跃分支：`china/pr-rg-refund-state-mutation-audit-persistence-adapter-plan`
- 当前 `origin/main` 最新合并提交：`f6abaa4` `Merge pull request #477 from morphius001/china/pr-rf-refund-state-mutation-approval-persistence-adapter-plan`
- 最近已合并 PR：`#455`、`#456`、`#457`、`#458`、`#459`、`#460`、`#461`、`#462`、`#463`、`#464`、`#465`、`#466`、`#467`、`#468`、`#469`、`#470`、`#471`、`#472`、`#473`、`#474`、`#475`、`#476`、`#477`
- 当前自动队列任务：`refund-state-mutation-audit-persistence-adapter-plan`
